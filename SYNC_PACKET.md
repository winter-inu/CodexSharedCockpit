...
- 新增第一集完整剧情大纲草案 `EPISODE_01_OUTLINE.md`。

## 当前任务
1. 审阅第一集“澜冰屿 + 澪星”完整剧情大纲草案，确认标题、遗憾事件、代价呈现和结尾钩子。
2. 编写第 2-4 集陆衡、林见舟、许明烬先后登场的分集梗概。
3. 完善第 5 集《无人到站》为完整单集大纲。
4. 根据新版陆衡视觉更新角色海报资产。
5. 在第一集大纲确认后，建立第一集关键帧 Prompt。
...
## Codex 下一步
等待用户 / ChatGPT 审阅 `EPISODE_01_OUTLINE.md`。若第一集大纲方向确认，下一步可继续拆第 1 集关键帧 Prompt，或转入第 2-4 集角色登场分集梗概。
