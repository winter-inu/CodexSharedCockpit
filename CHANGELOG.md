...
## 2026-05-17 第一集视频化测试方案

### Added

- 新增 `EPISODE_01_VIDEO_TEST_PLAN.md`。
- 明确第一轮视频化测试先做 60-90 秒测试段，不直接制作完整 15 分钟正片。
- 第一轮优先测试 7:30-9:30 第一次失败段落，覆盖 S18、S20 以及 B 类镜头 S19、S21、S22、S24。
- 同步 `TASK_BOARD.md` 和 `SYNC_PACKET.md`，下一步为审阅第一集视频化测试方案。
